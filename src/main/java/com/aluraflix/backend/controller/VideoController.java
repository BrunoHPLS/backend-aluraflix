...
public class VideoController {
    ...
    public ResponseEntity<Page<VideoResponseDTO>> getAll(@RequestParam(required = false) String search){
        return new ResponseEntity<>(service.findAll(search), HttpStatus.OK);
    }
